"""PDSSP Crawler configuration module."""

# TODO: Configuration parameters should be defined in a config.yaml file that can be read/written -> Config class.
# TODO: LOCAL_REGISTRY_DIRECTORY should be defined relative to package directory
...
# STAC_GITHUB_REPOSITORY = 'https://github.com/pdssp/pdssp-stac-repo'
